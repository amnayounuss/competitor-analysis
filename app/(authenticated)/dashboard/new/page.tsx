...
export default async function NewAnalysisPage() {
  ...
  return (
    <div className="max-w-3xl p-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="mb-8">
        <h1 className="text-3xl font-black text-slate-900 tracking-tight">New Analysis</h1>
        <p className="text-slate-500 font-medium mt-1">Define your target brand and competitors to start the scraper.</p>
      </div>
